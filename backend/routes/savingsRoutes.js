...
const { getGoals, createGoal, updateGoal, deleteGoal, transfer, getTransfers, completeGoal, bulkAction, respondToGoalInvite, archiveTransfer, emptyTransfersArchives } = require('../controllers/savingsController');
